...
savefig("lnl_surfaces/n2_theta1_lambda_surface.svg")
...
savefig("lnl_surfaces/n2_theta2_lambda_surface.svg")
...
savefig("lnl_surfaces/n2_theta1_theta2_contour.svg")
...
savefig("lnl_surfaces/n2_theta1_theta2_surface.svg")
"""

### data10
# theta1 and lambda
xs = range(maximum(data10), maximum(data10)+4, length=30)
ys = range(-2,2, length=30)
...
scatter!([theta1], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n10_theta1_lambda_contour.svg")
...
savefig("lnl_surfaces/n10_theta1_lambda_surface.svg")

# theta2 and lambda
xs = range(minimum(data10)-18, minimum(data10), length=30)
ys = range(-2,2, length=30)
...
scatter!([theta2], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n10_theta2_lambda_contour.svg")
...
savefig("lnl_surfaces/n10_theta2_lambda_surface.svg")

# theta1 and theta2
xs = range(maximum(data10), maximum(data10)+4, length=30)
ys = range(minimum(data10)-18, minimum(data10), length=30)
...
scatter!([theta1], [theta2], color="black", legend=false)
savefig("lnl_surfaces/n10_theta1_theta2_contour.svg")
...
savefig("lnl_surfaces/n10_theta1_theta2_surface.svg")
...
scatter!([theta1], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n50_theta1_lambda_contour.svg")
...
savefig("lnl_surfaces/n50_theta1_lambda_surface.svg")

# theta2 and lambda
xs = range(minimum(data50)-14, minimum(data50), length=30)
ys = range(-2,2, length=30)
...
scatter!([theta2], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n50_theta2_lambda_contour.svg")
...
savefig("lnl_surfaces/n50_theta2_lambda_surface.svg")

# theta1 and theta2
xs = range(maximum(data50), maximum(data50)+1.2, length=30)
ys = range(minimum(data50)-14, minimum(data50), length=30)
...
scatter!([theta1], [theta2], color="black", legend=false)
savefig("lnl_surfaces/n50_theta1_theta2_contour.svg")
...
savefig("lnl_surfaces/n50_theta1_theta2_surface.svg")
...
scatter!([theta1], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n100_theta1_lambda_contour.svg")
...
savefig("lnl_surfaces/n100_theta1_lambda_surface.svg")

# theta2 and lambda
xs = range(minimum(data100)-18, minimum(data100), length=30)
ys = range(-2,2, length=30)
...
scatter!([theta2], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n100_theta2_lambda_contour.svg")
...
savefig("lnl_surfaces/n100_theta2_lambda_surface.svg")

# theta1 and theta2
xs = range(maximum(data100), maximum(data100)+0.2, length=30)
ys = range(minimum(data100)-18, minimum(data100), length=30)
...
scatter!([theta1], [theta2], color="black", legend=false)
savefig("lnl_surfaces/n100_theta1_theta2_contour.svg")
...
savefig("lnl_surfaces/n100_theta1_theta2_surface.svg")
...
scatter!([theta1], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n1000_theta1_lambda_contour.svg")
...
savefig("lnl_surfaces/n1000_theta1_lambda_surface.svg")

# theta2 and lambda
xs = range(minimum(data1000)-15, minimum(data1000), length=30)
ys = range(-2,2, length=30)
...
scatter!([theta2], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n1000_theta2_lambda_contour.svg")
...
savefig("lnl_surfaces/n1000_theta2_lambda_surface.svg")

# theta1 and theta2
xs = range(maximum(data1000), maximum(data1000)+0.2, length=30)
ys = range(minimum(data1000)-15, minimum(data1000), length=30)
...
scatter!([theta1], [theta2], color="black", legend=false)
savefig("lnl_surfaces/n1000_theta1_theta2_contour.svg")
...
savefig("lnl_surfaces/n1000_theta1_theta2_surface.svg")
...
scatter!([theta1], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n10000_theta1_lambda_contour.svg")
...
savefig("lnl_surfaces/n10000_theta1_lambda_surface.svg")

# theta2 and lambda
xs = range(minimum(data10000)-1, minimum(data10000), length=30)
ys = range(-2,2, length=30)
...
scatter!([theta2], [lambda], color="black", legend=false)
savefig("lnl_surfaces/n10000_theta2_lambda_contour.svg")
...
savefig("lnl_surfaces/n10000_theta2_lambda_surface.svg")

# theta1 and theta2
xs = range(maximum(data10000), maximum(data10000)+0.2, length=30)
ys = range(minimum(data10000)-1.5, minimum(data10000), length=30)
...
scatter!([theta1], [theta2], color="black", legend=false)
savefig("lnl_surfaces/n10000_theta1_theta2_contour.svg")
...
savefig("lnl_surfaces/n10000_theta1_theta2_surface.svg")
...
savefig("marginal_vs_n/marginal_lambda_vs_n.svg")
...
savefig("marginal_vs_n/marginal_theta1_vs_n.svg")
...
savefig("marginal_vs_n/marginal_theta2_vs_n.svg")
...
savefig("marginal_small_vs_large_n/marginal_lambda_vs_small_n.svg")
...
savefig("marginal_small_vs_large_n/marginal_theta1_vs_small_n.svg")
...
savefig("marginal_small_vs_large_n/marginal_theta2_vs_small_n.svg")
