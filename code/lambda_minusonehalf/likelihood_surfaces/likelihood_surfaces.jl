...
### data10
# theta1 and lambda
xs = range(maximum(data10), maximum(data10)+25, length=30)
ys = range(-2,2, length=30)
...
### data50
# theta1 and lambda
xs = range(maximum(data50), maximum(data50)+25, length=30)
ys = range(-2,2, length=30)
...
### data100
# theta1 and lambda
xs = range(maximum(data100), maximum(data100)+7, length=30)
ys = range(-2,2, length=30)
...
### data1000
# theta1 and lambda
xs = range(maximum(data1000), maximum(data1000)+7, length=30)
ys = range(-2,2, length=30)
...
### data10000
# theta1 and lambda
xs = range(maximum(data10000), maximum(data10000)+7, length=30)
ys = range(-2,2, length=30)
