...
# save the fig
savefig("sigma_1/thetae1_sd1.svg")
...
plot!(xticks = (1:length(ndata), ndata))
# save the fig
savefig("sigma_1/thetae1_sd1_iqrs.svg")

# fetch MCMC summaries
CSV.write("sigma_1/thetae1_sd1_posterior_stats.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta1[x])[1]), 1:length(sampling_theta1))))
CSV.write("sigma_1/thetae1_sd1_posterior_quantiles.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta1[x])[2]), 1:length(sampling_theta1))))
...
# save the fig
savefig("sigma_1/thetae2_sd1.svg")
...
plot!(xticks = (1:length(ndata), ndata))
# save the fig
savefig("sigma_1/thetae2_sd1_iqrs.svg")

# fetch MCMC summaries
CSV.write("sigma_1/thetae2_sd1_posterior_stats.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta2[x])[1]), 1:length(sampling_theta2))))
CSV.write("sigma_1/thetae2_sd1_posterior_quantiles.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta2[x])[2]), 1:length(sampling_theta2))))
...
hline!([theta1], color="black", legend=false, linestyle=:dash)
# save the fig
savefig("sigma_1/thetae12_1_sd1.svg")
...
hline!([theta2], color="black", legend=false, linestyle=:dash)
# save the fig
savefig("sigma_1/thetae12_2_sd1.svg")
...
plot!(xticks = (1:length(ndata), ndata))
# save the fig
savefig("sigma_1/thetae_all_sd1_iqrs.svg")
...
plot!(xticks = (1:length(ndata), ndata))
savefig("sigma_1/theta1_sd1_grouped_iqrs.svg")

@df iqrs_df_grouped groupedbar(:theta2, palette=mypalette, group=:group)
plot!(xticks = (1:length(ndata), ndata))
savefig("sigma_1/theta2_sd1_grouped_iqrs.svg")

# fetch MCMC summaries
CSV.write("sigma_1/thetae12_sd1_posterior_stats.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta12[x])[1]), 1:length(sampling_theta12))))
CSV.write("sigma_1/thetae12_sd1_posterior_quantiles.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta12[x])[2]), 1:length(sampling_theta12))))
...
hline!([theta1], color="black", legend=false, linestyle=:dash)
# save the fig
savefig("sigma_20/thetae1_sd20.svg")
...
plot!(xticks = (1:length(ndata), ndata))
# save the fig
savefig("sigma_20/thetae1_sd20_iqrs.svg")

# fetch MCMC summaries
CSV.write("sigma_20/thetae1_sd20_posterior_stats.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta1[x])[1]), 1:length(sampling_theta1))))
CSV.write("sigma_20/thetae1_sd20_posterior_quantiles.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta1[x])[2]), 1:length(sampling_theta1))))
...
hline!([theta2], color="black", legend=false, linestyle=:dash)
# save the fig
savefig("sigma_20/thetae2_sd20.svg")
...
plot!(xticks = (1:length(ndata), ndata))
# save the fig
savefig("sigma_20/thetae2_sd20_iqrs.svg")

# fetch MCMC summaries
CSV.write("sigma_20/thetae2_sd20_posterior_stats.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta2[x])[1]), 1:length(sampling_theta2))))
CSV.write("sigma_20/thetae2_sd20_posterior_quantiles.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta2[x])[2]), 1:length(sampling_theta2))))
...
hline!([theta1], color="black", legend=false, linestyle=:dash)
# save the fig
savefig("sigma_20/thetae12_1_sd20.svg")
...
hline!([theta2], color="black", legend=false, linestyle=:dash)
# save the fig
savefig("sigma_20/thetae12_2_sd20.svg")
...
plot!(xticks = (1:length(ndata), ndata))
# save the fig
savefig("sigma_20/thetae_all_sd20_iqrs.svg")
...
@df iqrs_df_grouped groupedbar(:theta1, palette=mypalette, group=:group)
plot!(xticks = (1:length(ndata), ndata))
savefig("sigma_20/theta1_sd20_grouped_iqrs.svg")

@df iqrs_df_grouped groupedbar(:theta2, palette=mypalette, group=:group)
plot!(xticks = (1:length(ndata), ndata))
savefig("sigma_20/theta2_sd20_grouped_iqrs.svg")

# fetch MCMC summaries
CSV.write("sigma_20/thetae12_sd20_posterior_stats.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta12[x])[1]), 1:length(sampling_theta12))))
CSV.write("sigma_20/thetae12_sd20_posterior_quantiles.txt",
          reduce(vcat, map(x -> DataFrame(describe(sampling_theta12[x])[2]), 1:length(sampling_theta12))))
