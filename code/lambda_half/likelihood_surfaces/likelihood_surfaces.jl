...
### data10
# theta1 and lambda
xs = range(maximum(data10), maximum(data10)+6, length=30)
ys = range(-2,2, length=30)
...
# theta2 and lambda
xs = range(minimum(data50)-6, minimum(data50), length=30)
ys = range(-2,2, length=30)
...
# theta1 and theta2
xs = range(maximum(data50), maximum(data50)+1.2, length=30)
ys = range(minimum(data50)-6, minimum(data50), length=30)
...
# theta2 and lambda
xs = range(minimum(data100)-2, minimum(data100), length=30)
ys = range(-2,2, length=30)
...
# theta1 and theta2
xs = range(maximum(data100), maximum(data100)+0.2, length=30)
ys = range(minimum(data100)-2, minimum(data100), length=30)
...
scatter!([theta1], [theta2], color="white", legend=false)
...
# theta2 and lambda
xs = range(minimum(data1000)-2, minimum(data1000), length=30)
ys = range(-2,2, length=30)
...
# theta1 and theta2
xs = range(maximum(data1000), maximum(data1000)+0.2, length=30)
ys = range(minimum(data1000)-2, minimum(data1000), length=30)
...
# theta1 and theta2
xs = range(maximum(data10000), maximum(data10000)+0.2, length=30)
ys = range(minimum(data10000)-1, round(minimum(data10000);digits=2), length=30)
